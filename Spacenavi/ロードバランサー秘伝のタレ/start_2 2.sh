...
implicit_ssl=YES
listen_port=990' > /etc/vsftpd/vsftpd.conf




echo '# vsftpd userlist
...
# spacenavi.jpの箇所を申請したURLにしましょう。
# ドキュメントルートも変更しましょう。' > /etc/httpd/conf.d/vhost.conf
